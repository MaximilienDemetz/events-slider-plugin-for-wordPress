...
var CalendarDisplay = function (_React$Component) {
    _inherits(CalendarDisplay, _React$Component);
    ...
    function CalendarDisplay(props) {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = CalendarDisplay.__proto__ || Object.getPrototypeOf(CalendarDisplay)).call.apply(_ref, [this].concat(_toConsumableArray(props))));
